...
export function TimeIcon(props: IconType) {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M13.75 7.5C13.75 10.95 10.95 13.75 7.5 13.75C4.05 13.75 1.25 10.95 1.25 7.5C1.25 4.05 4.05 1.25 7.5 1.25C10.95 1.25 13.75 4.05 13.75 7.5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M9.81874 9.48711L7.88124 8.33086C7.54374 8.13086 7.26874 7.64961 7.26874 7.25586V4.69336" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
...
export function AddCookIcon(props: IconType) {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M8.50002 1.41602C6.64419 1.41602 5.13544 2.92477 5.13544 4.7806C5.13544 6.60102 6.55919 8.07435 8.41502 8.1381C8.47169 8.13102 8.52835 8.13102 8.57085 8.1381C8.58502 8.1381 8.5921 8.1381 8.60627 8.1381C8.61335 8.1381 8.61335 8.1381 8.62044 8.1381C10.4338 8.07435 11.8575 6.60102 11.8646 4.7806C11.8646 2.92477 10.3559 1.41602 8.50002 1.41602Z" fill="currentColor"/>
      <path d="M12.0983 10.0233C10.1221 8.70578 6.89914 8.70578 4.90872 10.0233C4.00914 10.6254 3.51331 11.4399 3.51331 12.3112C3.51331 13.1824 4.00914 13.9899 4.90164 14.5849C5.89331 15.2508 7.19664 15.5837 8.49997 15.5837C9.80331 15.5837 11.1066 15.2508 12.0983 14.5849C12.9908 13.9829 13.4866 13.1754 13.4866 12.297C13.4796 11.4258 12.9908 10.6183 12.0983 10.0233ZM9.91664 12.8424H9.03122V13.7279C9.03122 14.0183 8.79039 14.2591 8.49997 14.2591C8.20956 14.2591 7.96872 14.0183 7.96872 13.7279V12.8424H7.08331C6.79289 12.8424 6.55206 12.6016 6.55206 12.3112C6.55206 12.0208 6.79289 11.7799 7.08331 11.7799H7.96872V10.8945C7.96872 10.6041 8.20956 10.3633 8.49997 10.3633C8.79039 10.3633 9.03122 10.6041 9.03122 10.8945V11.7799H9.91664C10.2071 11.7799 10.4479 12.0208 10.4479 12.3112C10.4479 12.6016 10.2071 12.8424 9.91664 12.8424Z" fill="currentColor"/>
    </svg>
  )
}
...
export function AvatarIcon(props: IconType) {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M256 288c79.5 0 144-64.5 144-144S335.5 0 256 0 112 64.5 112 144s64.5 144 144 144zm128 32h-55.1c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16H128C57.3 320 0 377.3 0 448v16c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48v-16c0-70.7-57.3-128-128-128z" fill="currentColor"/>
    </svg>
  )
}
